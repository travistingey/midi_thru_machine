...
'Intentions: nobility of, humility of, or credibility of',
'Into the impossible',
'Is it finished?',
...
'Tape your mouth (by Ritva Saarikko)',
...
function Strategies:draw()
    return self.deck[math.random(181)]
end